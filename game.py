...
if squares == 0:
    imgs = ["res/alive_8.bmp","res/dead_8.bmp",8]
if squares == 1:
    imgs = ["res/alive_16.bmp","res/dead_16.bmp",16]
if squares == 2:
    imgs = ["res/alive_32.bmp","res/dead_32.bmp",32]
if squares == 3:
    imgs = ["res/alive_64.bmp","res/dead_64.bmp",64]
